...
using System.Linq;
using System.Xml;
using StructuredFileDiff.Lib.Xml;
using StructuredFileDiff.Lib.Result;
using System.Reflection;
using Scriban;
using StructuredFileDiff.Lcs;

namespace StructuredFileDiff.Cmd
{
    class Program
    {
        ...
        private static string RenderStreaks(List<StringDiff> streaks, params StreakType[] allowedStreakTypes)
        {
            string output = String.Empty;
            foreach (StringDiff streak in streaks.Where(x => allowedStreakTypes.Contains(x.StreakType)))
            {
